      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
              Connecting education to careers through personalized guidance,
              comprehensive information, and real-world insights.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <a
                  href="https://www.talentcorp.com.my/"
                  className="text-base text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
                >
                  TalentCorp Malaysia
                </a>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
          <p className="text-center text-base text-gray-500 dark:text-gray-400">
            &copy; {currentYear} EduPath Malaysia. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
